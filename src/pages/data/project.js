...
export const project = [
  {
    title: "Ecommerce",
    description:
      "This is a e-commerence website that allows the user to buy products online.",
    image: cart,
    tags: ["react", "tailwind", "context-api"],
    sourceCode: "https://github.com/manavss/ecommerceWebsite",
    demo: "https://ecommercewebstore.netlify.app/",
  },
  {
  ...
  },
  {
    ...
    description:
      "Experience the future of sportswear with the beautiful Nike landing page .",
    image: nike,
    tags: ["react", "tailwind"],
    sourceCode: "https://github.com/manavss/nikeWebsite",
    demo: "https://nike-landing-page-react.netlify.app/",
  },
  {
